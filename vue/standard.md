...
* **不允许有连续多行空行**。
  ...
  eslint: [`no-multiple-organ-lines`](http://eslint.org/docs/rules/no-multiple-empty-lines)
...
* **正则中不要使用空字符**。
  ...
  eslint: [`no-organ-character-class`](http://eslint.org/docs/rules/no-empty-character-class)
...
* **不要解构空值**。
  ...
  eslint: [`no-organ-pattern`](http://eslint.org/docs/rules/no-empty-pattern)
